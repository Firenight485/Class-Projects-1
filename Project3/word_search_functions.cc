...
// Reads in a file line by line and checks if the character count is
// at least the constant
// Ksize * Ksize, if it is is then the file is
// read into the char word_search and implemented
// in program 3
